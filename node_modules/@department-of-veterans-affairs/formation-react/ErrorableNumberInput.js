 ...
 *
 */
var ErrorableNumberInput = /*#__PURE__*/function (_React$Component) {
  _inherits(ErrorableNumberInput, _React$Component);

  function ErrorableNumberInput() {
    var _this;

    _classCallCheck(this, ErrorableNumberInput);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ErrorableNumberInput).call(this));
    _this.handleChange = _this.handleChange.bind(_assertThisInitialized(_this));
    _this.handleBlur = _this.handleBlur.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(ErrorableNumberInput, [{
    key: "UNSAFE_componentWillMount",
    value: function UNSAFE_componentWillMount() {
      this.inputId = (0, _uniqueId2["default"])('errorable-number-input-');
    }
  }, {
    key: "handleChange",
    ...
    value: function render() {
      ...
      var errorSpan = '';
      var errorSpanId = undefined; // TODO: Look into an alternate way of adding error styling not based on presence of errorMessage:
  ...
  return ErrorableNumberInput;
}(_react["default"].Component);

var _default = ErrorableNumberInput;
