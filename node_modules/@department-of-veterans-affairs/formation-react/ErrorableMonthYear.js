 ...
 */
var ErrorableMonthYear = /*#__PURE__*/function (_React$Component) {
  _inherits(ErrorableMonthYear, _React$Component);

  function ErrorableMonthYear() {
    var _this;

    _classCallCheck(this, ErrorableMonthYear);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ErrorableMonthYear).call(this));
    _this.handleChange = _this.handleChange.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(ErrorableMonthYear, [{
    ...
    value: function render() {
      ...
      var _this$props$date = this.props.date,
          ...
          year = _this$props$date.year; // we want to do validations in a specific order, so we show the message
      ...
      if (month.dirty && year.dirty) {
        ...
        } else if (!(0, _validations.isValidPartialMonthYear)(month.value, year.value)) {
          isValid = false;
      ...
      }, _react["default"].createElement("label", null, this.props.label, this.props.required && _react["default"].createElement("span", {
...
var _default = ErrorableMonthYear;
